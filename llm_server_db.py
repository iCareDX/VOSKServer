...
class TruncatedConversationBufferMemory(ConversationBufferMemory):
    def __init__(self, **kwargs):
        ...
        self._db = []  # Using a list to store chat history in memory
        self._db_file = kwargs.get('db_file', 'chat_history.json')
    ...
    def truncate_history(self):
        ...
        while total_tokens > TOKEN_LIMIT:
            ...
            self.save_to_db(removed_message)
    ...
    def save_to_db(self, message):
        # Simulating database save by appending to the list
        self._db.append({
            'role': message.role,
